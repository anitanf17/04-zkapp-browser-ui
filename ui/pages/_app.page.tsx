...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp [wildanmuhib]</title>
        <meta name="description" content="ZkApp By wildanmuhib" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/wildanmuhib1511" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/827065836031442964" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/wildanmuhib" target="_blank" rel="noopener noreferrer" >
